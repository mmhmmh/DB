 ...
 * @author Mark
 */
public class FianaceFilter implements Filter {
    ...
    public FianaceFilter() {
    }    
    
    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("FianaceFilter:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("FianaceFilter:DoAfterProcessing");
        }
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            ...
            RoleHelper.Role recordedRole = RoleHelper.getUserRole(username);

            if (recordedRole != RoleHelper.Role.Finance) {
    ...
    public void init(FilterConfig filterConfig) {        
        ...
        if (filterConfig != null) {
            if (debug) {                
                log("FianaceFilter:Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("FianaceFilter()");
        }
        StringBuffer sb = new StringBuffer("FianaceFilter(");
