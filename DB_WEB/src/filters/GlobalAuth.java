 ...
 * @author Mark
 */
public class GlobalAuth implements Filter {

    protected String loginPage = "/DB/login.jsp";
    ...
    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
        ...
        if (debug) {
            log("GlobalAuth:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("GlobalAuth:DoAfterProcessing");
        }
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (!url.contains("login.jsp") && !url.contains("checkLogin.jsp") && !url.contains("default.css")) {
            try {
                ...
                if (recordedRole == RoleHelper.Role.Unknown) {
    ...
    public void init(FilterConfig filterConfig) {
        ...
        if (filterConfig != null) {
            if (debug) {
                log("GlobalAuth:Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        ...
        StringBuffer sb = new StringBuffer("GlobalAuth(");
